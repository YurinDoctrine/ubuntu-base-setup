...
sudo apt-get remove --purge -y apport mailutils ristretto evince at avahi-daemon avahi-utils dovecot nfs-kernel-server nfs-common portmap rpcbind autofs snmp \
