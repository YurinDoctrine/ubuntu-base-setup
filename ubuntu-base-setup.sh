...
# Before hop in
sudo apt update &&
    sudo apt install -f --assume-yes 9base binutils curl fonts-terminus git gnupg2 haveged kmod pkgconf psmisc software-properties-common ufw zstd wget xdg-utils &&
