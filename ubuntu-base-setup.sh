...
sudo sed -i -e 's| defaults| rw,lazytime,relatime,commit=60|g' /etc/fstab
sudo sed -i -e 's| errors=remount-ro| rw,lazytime,relatime,commit=60,errors=remount-ro|g' /etc/fstab
