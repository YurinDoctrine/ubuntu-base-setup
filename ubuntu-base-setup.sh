...
sudo sed -i -e 's| defaults| rw,lazytime,relatime,commit=3600,noacl,nobarrier,nofail,discard|g' /etc/fstab
sudo sed -i -e 's| errors=remount-ro| rw,lazytime,relatime,commit=3600,noacl,nobarrier,nofail,discard,errors=remount-ro|g' /etc/fstab
