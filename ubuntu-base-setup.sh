...
# Before hop in
sudo apt update &&
    sudo apt install -f --assume-yes 9base base-files binutils git gnupg2 haveged kmod libinput-dev lz4 pkgconf psmisc software-properties-common ufw wget xdg-utils &&
