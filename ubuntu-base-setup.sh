...
sudo sed -i -e 's| defaults | relatime,space_cache,compress=lz4,discard=async,commit=60 |g' /etc/fstab
sudo sed -i -e 's| errors=remount-ro 0 | relatime,space_cache,compress=lz4,discard=async,commit=60,errors=remount-ro 0 |g' /etc/fstab
