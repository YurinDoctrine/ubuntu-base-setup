...
sudo apt-get remove --purge -y apport mailutils ristretto evince at avahi-daemon avahi-utils geany gigolo gimp hexchat dovecot nfs-kernel-server nfs-common portmap rpcbind autofs snmp \
