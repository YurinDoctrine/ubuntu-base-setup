...
sudo sed -i -e 's| defaults| rw,lazytime,relatime,commit=600,nobarrier,data=ordered|g' /etc/fstab
sudo sed -i -e 's| errors=remount-ro| rw,lazytime,relatime,commit=600,nobarrier,data=ordered,errors=remount-ro|g' /etc/fstab
